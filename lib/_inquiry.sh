...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB Paipa que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Paipa, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Paipa\n"
  printf "   [1] Atualizar Paipa\n"
  printf "   [2] Deletar Paipa\n"
  printf "   [3] Bloquear Paipa\n"
  printf "   [4] Desbloquear Paipa\n"
  printf "   [5] Alter. dominio Paipa\n"
  printf "\n"
  read -p "> " option
